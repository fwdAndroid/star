...
class PulipInbox extends StatefulWidget {
  const PulipInbox({super.key});

  @override
  State<PulipInbox> createState() => _PulipInboxState();
}

class _PulipInboxState extends State<PulipInbox> {
  @override
